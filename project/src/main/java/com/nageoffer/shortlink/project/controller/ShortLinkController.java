...
public class ShortLinkController {
    ...
    public Result<ShortLinkCreateRespDTO> createShortLink(@RequestBody ShortLinkCreateReqDTO requestParam,HttpServletRequest request,HttpServletResponse response) throws IOException {
        return Result.success("创建短链接成功",shortLinkService.createShortLink(requestParam,request,response));
    }
